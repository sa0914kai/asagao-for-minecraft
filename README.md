...
これでDiscordアプリから作ったBotアカウントを悪人できると思います。
...
API通信がうまくいかなかったときなど、エラーを出して処理が中断、Pythonスクリプトの実行を終了したりする場合があります。

その場合はもう一度実行することでうまくいくこともありますが、ConoHaの管理画面から手を加えることをおすすめします。
